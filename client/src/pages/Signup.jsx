    ...
    <div className='min-h-screen mt-20'>
      <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5'>
        ...
        <p className='text-sm mt-5'> 
          This is a demo project for blogging. you can signup with your email and password 
        ...
        <div className='flex-1'>
          ...
          <div>
            <p className='text-sm mt-5'> 
              Already have an account? <Link to="/sign-in" className='text-blue-500 ml-0.5'>Sign In</Link>
            </p>
          </div>
          {
            errorMessage && (
